---
name: WBtest
description: Runs the project's test suite for the current changes and reports pass/fail with failure details. Standalone stage of wb-spell. Use for "WBtest", "run the tests", "check tests pass".
